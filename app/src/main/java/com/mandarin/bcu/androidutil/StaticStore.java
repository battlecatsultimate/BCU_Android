...
public class StaticStore {
    ...
    public static final String VER = "0.14.21";
    ...
    public static final String[] OPTREQS = {"080504", "090404", "090406", "090501", "090803"};
    /**Locale codes list**/
    ...
    public static void filterReset() {
        ...
        starred = false;
        entityname = "";
        StatFilterElement.Companion.getStatFilter().clear();
    }
