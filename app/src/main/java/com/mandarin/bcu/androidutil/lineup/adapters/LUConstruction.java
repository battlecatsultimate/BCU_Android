...
public class LUConstruction extends Fragment {
    ...
    int [] layoutid = {R.id.castlelev,R.id.slowlev,R.id.walllev,R.id.stoplev,R.id.waterlev,R.id.zombielev,R.id.breakerlev};

    TextInputEditText text;
    TextInputEditText [] texts = new TextInputEditText[7];
    int [] textid = {R.id.castlelevt,R.id.slowlevt,R.id.walllevt,R.id.stoplevt,R.id.waterlevt,R.id.zombielevt,R.id.breakerlevt};
