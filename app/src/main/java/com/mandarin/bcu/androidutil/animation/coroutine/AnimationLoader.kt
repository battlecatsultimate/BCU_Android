                    ...
                    when (item.itemId) {
                        ...
                        R.id.anim_gif_range -> {
                            if(!StaticStore.gifisSaving) {
                                ...
                                val gifAdapter = GIFRangeRecycle(name, activity, type, content, -1)
                                ...
                                gen.setOnClickListener(object : SingleClick() {
                                    override fun onSingleClick(v: View?) {
                                        ...
                                        GIFRange(activity, content, type, index, cView, !shared.getBoolean("theme", false), gifAdapter.getData(), gifAdapter.getEnables()).execute()
