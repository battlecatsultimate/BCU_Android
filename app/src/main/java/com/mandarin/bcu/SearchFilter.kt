...
class SearchFilter : AppCompatActivity() {
    ...
    private val abid = intArrayOf(R.id.schchabwe, R.id.schchabfr, R.id.schchabsl, R.id.schchabta, R.id.schchabst, R.id.schchabre, R.id.schchabir, R.id.schchabmd, R.id.schchabid, R.id.schchabkb, R.id.schchabiv, R.id.schchabwp, R.id.schchabstr, R.id.schchabsu,
            ...
            R.id.schchabimwp, R.id.schchabimcu, R.id.schchabws, R.id.schchabwik, R.id.schchabevk)
    private val abtool = intArrayOf(R.string.sch_abi_we, R.string.sch_abi_fr, R.string.sch_abi_sl, R.string.sch_abi_ao, R.string.sch_abi_st, R.string.sch_abi_re, R.string.sch_abi_it, R.string.sch_abi_md, R.string.sch_abi_id, R.string.sch_abi_kb,
            ...
            R.string.sch_abi_wv, R.string.sch_abi_surge, R.string.sch_abi_iw, R.string.sch_abi_if, R.string.sch_abi_is, R.string.sch_abi_ik, R.string.sch_abi_iwv, R.string.sch_abi_iwa, R.string.sch_abi_ic, R.string.sch_abi_ws, R.string.sch_abi_wk, R.string.sch_abi_eva)
    ...
    private val abdraw = intArrayOf(195, 197, 198, 202, 203, 204, 122, 206, 114, 207, 266, 231, 196, 199, 200, 201, 260, 264, 229, 205, 209, 208, 239, 213, 214, 215, 216, 210, 262, 116, 218, 258, 110)
