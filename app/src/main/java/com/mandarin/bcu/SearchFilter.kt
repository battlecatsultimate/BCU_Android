...
class SearchFilter : AppCompatActivity() {
    ...
    private val abid = intArrayOf(R.id.schchabwe, R.id.schchabfr, R.id.schchabsl, R.id.schchabta, R.id.schchabst, R.id.schchabre, R.id.schchabir, R.id.schchabmd, R.id.schchabid, R.id.schchabkb, R.id.schchabiv, R.id.schchabwp, R.id.schchabstr, R.id.schchabsu,
