...
class SearchFilter : AppCompatActivity() {
    ...
    private val abid = intArrayOf(R.id.schchabwe, R.id.schchabfr, R.id.schchabsl, R.id.schchabta, R.id.schchabst, R.id.schchabre, R.id.schchabir, R.id.schchabmd, R.id.schchabid, R.id.schchabkb, R.id.schchabwp, R.id.schchabiv, R.id.schchabstr, R.id.schchabsu,
            R.id.schchabcd, R.id.schchabcr, R.id.schchabzk, R.id.schchabbb, R.id.schchabsb, R.id.schchabem, R.id.schchabme, R.id.schchabwv, R.id.schchabsur, R.id.schchabimwe, R.id.schchabimfr, R.id.schchabimsl, R.id.schchabimkb, R.id.schchabimwv,
            R.id.schchabimwp, R.id.schchabimcu, R.id.schchabimpoi, R.id.schchabws, R.id.schchabwik, R.id.schchabevk)
    private val abtool = intArrayOf(R.string.sch_abi_we, R.string.sch_abi_fr, R.string.sch_abi_sl, R.string.sch_abi_ao, R.string.sch_abi_st, R.string.sch_abi_re, R.string.sch_abi_it, R.string.sch_abi_md, R.string.sch_abi_id, R.string.sch_abi_kb,
            R.string.sch_abi_wa, R.string.sch_abi_iv, R.string.sch_abi_str, R.string.sch_abi_su, R.string.sch_abi_bd, R.string.sch_abi_cr, R.string.sch_abi_zk, R.string.sch_abi_bb, R.string.sch_abi_sb, R.string.sch_abi_em, R.string.sch_abi_me,
            R.string.sch_abi_wv, R.string.sch_abi_surge, R.string.sch_abi_iw, R.string.sch_abi_if, R.string.sch_abi_is, R.string.sch_abi_ik, R.string.sch_abi_iwv, R.string.sch_abi_iwa, R.string.sch_abi_ic, R.string.sch_abi_impoi ,R.string.sch_abi_ws, R.string.sch_abi_wk, R.string.sch_abi_eva)
    ...
    private val abils = arrayOf(intArrayOf(1, Data.P_WEAK), intArrayOf(1, Data.P_STOP), intArrayOf(1, Data.P_SLOW), intArrayOf(0, Data.AB_ONLY), intArrayOf(0, Data.AB_GOOD), intArrayOf(0, Data.AB_RESIST), intArrayOf(0, Data.AB_RESISTS), intArrayOf(0, Data.AB_MASSIVE), intArrayOf(0, Data.AB_MASSIVES), intArrayOf(1, Data.P_KB), intArrayOf(1, Data.P_WARP), intArrayOf(1, Data.P_IMUATK), intArrayOf(1, Data.P_STRONG), intArrayOf(1, Data.P_LETHAL), intArrayOf(0, Data.AB_BASE), intArrayOf(1, Data.P_CRIT), intArrayOf(0, Data.AB_ZKILL), intArrayOf(1, Data.P_BREAK), intArrayOf(1, Data.P_SATK), intArrayOf(0, Data.AB_EARN), intArrayOf(0, Data.AB_METALIC), intArrayOf(1, Data.P_WAVE), intArrayOf(1, Data.P_VOLC), intArrayOf(1, Data.P_IMUWEAK), intArrayOf(1, Data.P_IMUSTOP), intArrayOf(1, Data.P_IMUSLOW), intArrayOf(1, Data.P_IMUKB), intArrayOf(1, Data.P_IMUWAVE), intArrayOf(1, Data.P_IMUWARP), intArrayOf(1, Data.P_IMUCURSE), intArrayOf(1, Data.P_IMUPOIATK) ,intArrayOf(0, Data.AB_WAVES), intArrayOf(0, Data.AB_WKILL), intArrayOf(0, Data.AB_EKILL))
    ...
    private val abdraw = intArrayOf(195, 197, 198, 202, 203, 204, 122, 206, 114, 207, 266, 231, 196, 199, 200, 201, 260, 264, 229, 205, 209, 208, 239, 213, 214, 215, 216, 210, 262, 116, 237, 218, 258, 110)
    ...
    private fun listeners() {
        ...
        reset.setOnClickListener {
            ...
            for (ability1 in abilities)
                if (ability1!!.isChecked)
                    ability1.isChecked = false
        }
